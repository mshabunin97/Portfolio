...
const Contacts = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_kzq9cpn', 'template_2v94neo', form.current, 'BQY9nvQggmj27MFSh')
      e.target.reset();
  };
        ...
        <div className="contacts__content">
          ...
          <div className="contacts__info">
            <div className="contacts__card">
              ...
              <span className="contacts__card-data">mshabunin97@gmail.com</span>

              <a
                href="mailto:mshabunin97@gmail.com"
          ...
          <div className="contacts__info">
            <div className="contacts__card">
              ...
              <span className="contacts__card-data">@Max_Shabunin</span>

              <a href="https://t.me/Max_Shabunin" className="contacts__button">
                Write me{" "}
                <i className="bx bx-right-arrow-alt contacts__button-icon"></i>
              </a>
            </div>
          ...
          <div className="contacts__info">
            ...
            <i className='bx bxs-phone contact__card-icon'></i>
              ...
              <span className="contacts__card-data">+7(964)-909-03-02</span>

              <a href="tel:+79649090302" className="contacts__button">
                Call me{" "}
                <i className="bx bx-right-arrow-alt contacts__button-icon"></i>
              </a>
            </div>
