...
import CV from './../../assets/Shabunin-Cv.pdf'
import AnimateHeading from '../utils/AnimateHeading';

const About = () => {
    useEffect(() => {
        AOS.init(); // Инициализация AOS после рендера компонента
      }, []);
    return (
        <section className="about section" id="about">
            <div className="section__title">
            <AnimateHeading text="About Me" />
            </div>
            ...
            <div className="about__container container">
                ...
                <div className="about__data" data-aos="fade-left" data-aos-duration="2000" data-aos-once="true">
                    ...
                    I am dedicated to crafting web applications that are not only functional but also visually appealing to users.
                    </p>
